/* Generated By:JavaCC: Do not edit this line. ParserOtras.java */
package Analizador_OtrasColumnas;


public class ParserOtras implements ParserOtrasConstants {
 ...
 Token t;
    if (jj_2_5(2)) {
      ...
      jj_consume_token(Ccor);
                                        {if (true) return t.image +"()pvnt0respuesta";}
    } else if (jj_2_7(2)) {
  ...
  public ParserOtrasTokenManager token_source;
  ...
  public ParserOtras(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public ParserOtras(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new ParserOtrasTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public ParserOtras(java.io.Reader stream) {
  ...
  public ParserOtras(ParserOtrasTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(ParserOtrasTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
